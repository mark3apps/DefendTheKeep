...
function CreateUnitsForPlayer0()
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("E002"), -18633.7, 2804.3, 250.265, FourCC("E002"))
end
...
function Trig_meelee_Actions()
end

function InitTrig_meelee()
    gg_trg_meelee = CreateTrigger()
    TriggerAddAction(gg_trg_meelee, Trig_meelee_Actions)
end
...
function RunInitializationTriggers()
    ...
    ConditionalTriggerExecute(gg_trg_meelee)
end
