...
export function GenerateNoButtonTalentView (cfg: IBasicTalentViewConfig, parent: Frame, index: string): ITalentView {
	...
	toolBox
		.setPoint(FramePoint.TR, parent, FramePoint.TL, -0.02, 0)
