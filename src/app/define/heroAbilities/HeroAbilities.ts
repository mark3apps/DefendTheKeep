...
export class HeroAbilities {
  ...
  private constructor(depend: IHeroAbilitiesDepend) {
    ...
    //     return Shift.fromHandle(unitAbil)
    //   },
    // })
    // // Switch
    ...
    //   TriggerUnit: abilCast.CastingHero,
    //   unitAbility: (unitAbil) => {
    //     return Switch.fromHandle(unitAbil)
    //   },
    // })
    // // Falling Strike
    ...
    //   TriggerUnit: abilCast.CastingHero,
    //   unitAbility: (unitAbil) => {
    //     return FallingStrike.fromHandle(unitAbil)
    //   },
    // })
    // // Fel Form
    ...
    //   TriggerUnit: abilCast.CastingHero,
    //   unitAbility: (unitAbil) => {
    //     return FelForm.fromHandle(unitAbil)
    //   },
    // })
    // // Fel Form
    ...
    //   TriggerUnit: abilCast.CastingHero,
    //   unitAbility: (unitAbil) => {
    //     return Shadestorm.fromHandle(unitAbil)
    //   },
    // })
  }
}
